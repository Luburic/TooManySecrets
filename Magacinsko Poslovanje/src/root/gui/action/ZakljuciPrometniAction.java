...
public class ZakljuciPrometniAction extends AbstractAction {
	private static final long serialVersionUID = 152144296572370143L;

	private GenericForm standardForm;

	public ZakljuciPrometniAction(GenericForm standardForm) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (i != -1) {
			if (JOptionPane
				...
				((PrometniDokumentStandardForm) standardForm).proknjiziDokument();
			}
