...
public class CrlCentralna {
	...
	public static CrlCentralna load() {
		...
		try {
			...
			CrlCentralna crlCentralna = (CrlCentralna) unmarshaller.unmarshal(new File("./xsdSchemas/crlcentralnabanka.xml"));
			//ispis na ekran
	...
	public void store(List<CrlCentralna.Bank> banks) {
		...
		try {
			JAXBContext context2 = JAXBContext.newInstance("crlCentralna");
