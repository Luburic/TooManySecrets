...
@WebServiceProvider(portName = "CentralnaClearingNalogPort", 
					serviceName = "CentralnaClearingNalog",
					targetNamespace = "http://www.toomanysecrets.com/CentralnaClearingNalog",
...
public class MT102Provider implements javax.xml.ws.Provider<DOMSource>{
	...
	private String apsolutePath103 = DocumentTransform.class.getClassLoader().getResource("mt102.xml").toString().substring(6);
	private String notificationPath = DocumentTransform.class.getClassLoader().getResource("Notification.xml").toString().substring(6);
	private MT103 mt103;

	public MT102Provider() {
