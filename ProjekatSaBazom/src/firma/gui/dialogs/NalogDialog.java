...
public class NalogDialog extends JDialog {
	...
	private JLabel lbSvr = new JLabel("Svrha plaćanja:");
	...
	private JDatePickerImpl tfDatNal = new JDatePickerImpl(new JDatePanelImpl(null));
		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (("").equals(tfDuz.getText())) {
					JOptionPane.showMessageDialog(null, "Obavezan unos duznika!", "Greska", JOptionPane.ERROR_MESSAGE);
					tfDuz.requestFocus();
					return;
				}

				if (("").equals(tfSvr.getText())) {
					JOptionPane.showMessageDialog(null, "Obavezan unos namene uplate!", "Greska",
							JOptionPane.ERROR_MESSAGE);
					tfSvr.requestFocus();
					return;
				}
				...
				if (("").equals(tfPrim.getText())) {
					JOptionPane.showMessageDialog(null, "Obavezan unos primaoca uplate!", "Greska",
							JOptionPane.ERROR_MESSAGE);
					tfPrim.requestFocus();
					return;
				}
				...
				if (("").equals(tfDatNal.getJFormattedTextField().getText())) {
					JOptionPane.showMessageDialog(null, "Obavezan unos datuma naloga!", "Greska",
							JOptionPane.ERROR_MESSAGE);
				...
				if (("").equals(tfRacDuz.getText())) {
					JOptionPane.showMessageDialog(null, "Obavezan unos racuna duznika!", "Greska",
							JOptionPane.ERROR_MESSAGE);
				...
				if (tfRacDuz.getText().length() != 18) {
					JOptionPane.showMessageDialog(null, "Neispravna duzina racuna duznika!", "Greska",
							JOptionPane.ERROR_MESSAGE);
					tfRacDuz.requestFocus();
					return;
				...
				if (cbModZad.getSelectedIndex() == 0) {
					JOptionPane.showMessageDialog(null, "Obavezan izbor modela zaduzenja!", "Greska",
							JOptionPane.ERROR_MESSAGE);
				...
				if (("").equals(tfPozBr.getText())) {
					JOptionPane.showMessageDialog(null, "Obavezan unos poziva na broj zaduzenja!", "Greska",
							JOptionPane.ERROR_MESSAGE);
				...
				if (("").equals(tfRacPov.getText())) {
					JOptionPane.showMessageDialog(null, "Obavezan unos racuna poverioca!", "Greska",
							JOptionPane.ERROR_MESSAGE);
				...
				if (tfRacPov.getText().length() != 18) {
					JOptionPane.showMessageDialog(null, "Neispravna duzina racuna poverioca!", "Greska",
							JOptionPane.ERROR_MESSAGE);
					tfRacPov.requestFocus();
					return;
				...
				if (cbModOdo.getSelectedIndex() == 0) {
					JOptionPane.showMessageDialog(null, "Obavezan izbor modela odobrenja!", "Greska",
							JOptionPane.ERROR_MESSAGE);
				...
				if (("").equals(tfPozOdo.getText())) {
					JOptionPane.showMessageDialog(null, "Obavezan unos poziva na broj odobrenja!", "Greska",
							JOptionPane.ERROR_MESSAGE);
