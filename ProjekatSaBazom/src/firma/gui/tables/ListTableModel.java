...
public class ListTableModel extends RowTableModel<List> {
	/**
	 * Initialize the List with null values. This will set the size of the List and will prevent an
	 * IndexOutOfBoundsException when trying to access an Element in the List.
	 * 
	 * @param size
	...
	/**
	 * Constructs an empty <code>ListTableModel</code> with default column names for the specified number of
	 * <code>columns</code>.
	 * 
	 * @param columns
	...
	/**
	 * Constructs an empty <code>ListTableModel</code> with customized column names. The number of columns is determined
	 * bye the number of items in the <code>columnNames</code> List.
	 * 
	 * @param columnNames
	...
	/**
	 * Constructs a <code>ListTableModel</code> with the specified number of rows. Default column names will be used for
	 * the specified number of <code>columns</code>.
	 * 
	 * @param rows
	...
	/*
	 * Copy the information in the Array to a List so a List can be added to the model
	 */
	 ...
	 * 
	 * The column names and class type will be retrieved from the ResultSetMetaData. The data is retrieved from each row
	 * found in the ResultSet. The class of
	 * 
	 * @param resultSet
