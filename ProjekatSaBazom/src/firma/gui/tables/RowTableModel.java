...
abstract class RowTableModel<T> extends AbstractTableModel {
	 ...
	 *         <code>columnNames</code> does not have an entry for this index then the default name provided by the
	 ...
	 * @exception IllegalArgumentException
	 *                when the Class of the row data does not match the row Class of the model.
	 */
	 ...
	 * 
	 * - insert a space when a new uppercase character is found, insert multiple upper case characters are grouped
	 * together. - replace any "_" with a space
	 * 
